<template>
  <div>
    ...
    <div class="md:pl-64 flex flex-col flex-1 justify-content-end">
...
import { SearchIcon, VideoCameraIcon, PhotographIcon, ShoppingCartIcon, DocumentIcon, UsersIcon } from '@heroicons/vue/solid'
export default {
  data() {
    return {
      navigation: [
        { name: 'Dashboard', href: '/admin/home', icon: HomeIcon, current: true },
        { name: 'All Videos', href: '/admin/videos', icon: VideoCameraIcon, current: false },
        { name: 'Create Video', href: '/admin/video-upload', icon: VideoCameraIcon, current: false },
        { name: 'All Images', href: '/admin/images', icon: PhotographIcon, current: false },
        { name: 'Create Image set', href: '/admin/image-set', icon: PhotographIcon, current: false },
        //{ name: 'Store sales', href: '#', icon: ShoppingCartIcon, current: false },
        { name: 'All Users', href: '/admin/users', icon: UsersIcon, current: false}
      ],
      userNavigation: [
  ...
  components: {
    SearchIcon, VideoCameraIcon, PhotographIcon, ShoppingCartIcon, DocumentIcon, MenuAlt2Icon, Dialog, DialogPanel, TransitionChild,
    XIcon, TransitionRoot, MenuButton, MenuItem, MenuItems, Menu
  },
  methods: {
    checkUser() {
