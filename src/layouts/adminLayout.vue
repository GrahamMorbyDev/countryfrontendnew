                    ...
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
                        <DialogPanel class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-indigo-700">
                            ...
                            <div class="flex-shrink-0 flex items-center px-4">
                                <span>Country On The Coast</span>
                            </div>
        ...
        <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
            ...
            <div class="flex flex-col flex-grow pt-5 bg-indigo-700 overflow-y-auto">
                <div class="flex items-center flex-shrink-0 px-4">
                    <span class="text-xl truncate text-white font-bold">Borderland Bound</span>
                </div>
                        ...
                        <form class="w-full flex md:ml-0" action="#" method="GET">
                            ...
                            <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                                ...
                                <input id="search-field" type="search" name="search"
                                    class="block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-500 
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <Menu as="div" class="ml-3 relative">
                            <div>
                                ...
                                <img class="h-8 w-8 rounded-full" src="@/assets/dark-logo.png" alt="" />
                                </MenuButton>
                            </div>
...
import { BellIcon, CalendarIcon, ChartBarIcon, FolderIcon, HomeIcon, InboxIcon, MenuAlt2Icon,  
         XIcon, PencilIcon, DocumentIcon, DocumentTextIcon, OfficeBuildingIcon } from '@heroicons/vue/outline';
import { getStorage } from "@/saveStorage";
import { SearchIcon, VideoCameraIcon, PhotographIcon, ShoppingCartIcon, UsersIcon } from '@heroicons/vue/solid';
export default {
    data() {
        return {
            navigation: [
                { name: 'Home',  href: '/admin/home',   icon: HomeIcon, current: true },
                { name: 'Users', href: '/admin/users',  icon: VideoCameraIcon, current: false },
                { name: 'Order', href: '/admin/orders', icon: VideoCameraIcon, current: false },
                { name: 'Blog',  href: '/admin/blog',   icon: PhotographIcon, current: false },
            ],
            userNavigation: [
    ...
    components: {
        SearchIcon, VideoCameraIcon, PhotographIcon, ShoppingCartIcon, DocumentIcon, MenuAlt2Icon, Dialog, DialogPanel, 
        TransitionChild, XIcon, TransitionRoot, MenuButton, MenuItem, MenuItems, Menu, PencilIcon, DocumentIcon, DocumentTextIcon
    },
